...
export default function OnboardingRolePage() {
  ...
  async function handleConfirm() {
    ...
    const sessions = readSessions();
    const existingSession = sessions.client ?? sessions.tasker ?? null;
    ...
    try {
      ...
      // writes a temp "tasker" session for new users before this step).
      const otherRole: Role = selected === "client" ? "tasker" : "client";
        ...
        <div className="mt-6">
          ...
          >
            {busy
              ? "Saving your role..."
              : selected
                ? `Continue as ${selected === "client" ? "Client" : "Tasker"}`
