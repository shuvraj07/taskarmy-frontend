...
// ── Palette matches TaskArmy brand ──────────────────────────────────────────
const C = {
  bg: "#f8f6ff",
  card: "#ffffff",
  border: "#ded7ee",
...
const MOCK: TaskerData = {
  name: "CurrentAI",
  email: "currentai@taskarmy.com",
  ...
  badges: [
    ...
    { label: "Top Tasker", icon: Award, color: C.amber },
  ],
  recentTasks: [
    {
      id: 12,
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 16, fontWeight: 800 }}>Tasker Profile</span>
        </div>
        ...
        <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              ...
              >
                {trust.label} Tasker · {p.stats.successRate}% success
              </span>
            </div>
          </div>
        </div>
